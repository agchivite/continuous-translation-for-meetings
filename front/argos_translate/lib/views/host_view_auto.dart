...
class HostViewAuto extends StatefulWidget {
  const HostViewAuto({super.key});

  @override
  HostViewAutoState createState() => HostViewAutoState();
}

class HostViewAutoState extends State<HostViewAuto> {
